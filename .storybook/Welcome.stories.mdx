...
<div className="px-3 py-6 min-h-screen font-thin">
  ...
  <div className="max-w-2xl mx-auto">
    ...
    <p>
      ...
      and hold multiple packages in it's <code>projects</code> directory. To get
      an idea on how to create a new package, look into the{" "}
      <code>packages/badge</code>'s implementation. All the styles for the
      components resides inside <code>packages/css</code> module. We are using{" "}
