...
export type StyleProps = ${generatePossibleValuesTypescriptTemplate(
    propsWithVariants
  )}
...
export { classNamesForKeys }`
  fs.writeFileSync(outputFile, themeContent)
