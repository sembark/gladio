...
```jsx live=true
<Alert type="assertive" status="success">Account details updated successfully.</Alert>
```
...
```jsx live=true
<Alert status="success">Project successfully created.</Alert>
```
...
```jsx live=true
<Alert type="assertive">Deletion of a project requires admin permissions.</Alert>
```
