...
export const meta = {
    ...
    name: "@tourepedia/datetime",
    usage:`import DateTime from "@tourepedia/datetime"
function App () {
  return <DateTime />
}`
};
...
Following components are exported from `@tourepedia/datetime` module.
...
```jsx live=true
// import DateTime from "@tourepedia/datetime"
...
```jsx live=true
// import { DateTimeInput } from "@tourepedia/DateTimeInput"
...
```jsx live=true
// import { DateTimePicker } from "@tourepedia/DateTimeInput"
